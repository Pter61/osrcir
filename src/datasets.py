        ...
        try:
            if self.mode == 'relative':
                ...
                if self.split in ['train', 'val']:
                    reference_image_path = str(self.dataset_path / 'images' / f"{reference_name}.png")
                    target_name = self.triplets[index]['target']
                    target_image_path = str(self.dataset_path / 'images' / f"{target_name}.png")
                    '''
                ...
                image_path = str(self.dataset_path / 'images' / f"{image_name}.png")
                '''
                    For GPT4V api, the preprocess are included in the model. Therefore, only needs the image urls (i.e., image paths)
                '''
                return {
